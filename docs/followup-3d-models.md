...
Nothing here touches copper, and every change is gated the same way: `tools/gerber-gate.sh
...
"$KICAD_PY" tools/align_models.py          # models that come from a KiCad footprint
"$KICAD_PY" tools/align_models_legacy.py   # models from the migrate2kicad10 branch
