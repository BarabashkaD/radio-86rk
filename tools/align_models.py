...
def transform(ours, kilib, kiname):
    ...
    # with a calibration board rendering eight candidate conventions side by side
    # against KiCad's own DIP-40 as a known-good reference. Only (ox, -oy, rot)
    # puts the chip body between its pad rows.
    #
